            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="filter-control">
                    <ul>
                        ...
                        <li class="item" data-tag=".Clothing" date-category="women">Clothing</li>
                        <li class="item" data-tag=".HandBag" date-category="women">HandBag</li>
                        <li class="item" data-tag=".Shoes" date-category="women">Shoes</li>
                        <li class="item" data-tag=".Accessories" date-category="women">Accessories</li>
                    </ul>
                </div>
                <div class="product-slider owl-carousel women">
                    @foreach($womenProducts as $womenProduct)
                        <div class="product-item{{ $womenProduct->tag }}">
                        <div class="pi-pic">
                            <img src="img/products/{{ $womenProduct->productImages[0]->path }}" alt="">
            ...
            <div class="col-lg-8">
                <div class="filter-control">
                    <ul>
                        ...
                        <li class="item" data-tag=".Clothing" date-category="men">Clothing</li>
                        <li class="item" data-tag=".HandBag" date-category="men">HandBag</li>
                        <li class="item" data-tag=".Shoes" date-category="men">Shoes</li>
                        <li class="item" data-tag=".Accessories" date-category="men">Accessories</li>
                    </ul>
                </div>
                <div class="product-slider owl-carousel men">
                    @foreach($menProducts as $menProduct)
                        <div class="product-item {{ $menProduct->tag }}">
                            <div class="pi-pic">
                                <img src="img/products/{{ $menProduct->productImages[0]->path }}" alt="">
