...
<head>
    ...
    <title>@yield('title') | DewShop</title>
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        ...
                        <li><a href="#">Brand Outdoor Appared</a> </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>Kinh Mon - Hai Duong</li>
                        <li>Phone:+84 356623270</li>
                        <li>Email:cuongdew@gmail.com</li>
                    </ul>
            ...
            <div class="col-lg-4">
                <div class="newslatter-item">
                    <h5>Jorn Our Newsletter Now</h5>
                    <p>Get E-mail update about our latest shop and special offer</p>
